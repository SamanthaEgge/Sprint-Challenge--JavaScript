...
//lowerCase = lowercase.map.toLowerCase();
...
*/
const largerPopulation = zooAnimals.filter((low) => {
...
*/
const populationTotal = zooAnimals.reduce((initial, amount) => {
  return (initial + amount.population);
},
0);
